--[[
  OceUA — Item_Fixed_Labels.lua
  ============================================================
  СЮДИ: точні службові рядки тултіпа предмета (Unique, Soulbound, Requires Level, Equip:, Use: тощо).
...
OceUA_Item_Fixed_Labels = {
  ...
  ["Attack Speed (seconds):"] = "Швидкість атаки (сек):",
